...
const jsonLd = {
  ...
  "@graph": [
    ...
    buildSoftwareApplication(p, { ratingValue: "4.9", ratingCount: "2153" }),
    {
      "@type": "HowTo",
      name: `How to convert ${p.name} videos with ${SITE_NAME}`,
      description: `Convert ${p.name} videos to MP3 audio in 3 easy steps.`,
      totalTime: "PT1M",
...
export default function TikTokToMp3Page() {
  return (
    <>
      ...
      />
      <PlatformPageClient platform={p} platformKey="tiktokToMp3" />
    </>
  );
}

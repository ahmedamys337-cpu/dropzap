...
export const glossaryEntries: GlossaryEntry[] = [
  ...
  },
  {
    ...
    description:
      "MP4 is the most common video file format on the internet. Learn what MP4 actually contains, why TikTok, Instagram, and other social platforms all use it, and how it differs from MOV, WEBM, and MKV.",
    shortDefinition:
      "MP4 (MPEG-4 Part 14) is a digital container format that holds video, audio, subtitles, and metadata in a single file. It is the dominant video format on the modern internet — TikTok, Instagram, X / Twitter, Facebook, and Reddit all serve videos as MP4 internally.",
    longDefinition:
  ...
  },
  {
    ...
    description:
      "H.264 is the video codec used by virtually every social media platform — TikTok, Instagram, Facebook, Twitter. Learn what H.264 is and why it dominates internet video.",
    shortDefinition:
      "H.264 (also called AVC, Advanced Video Coding) is the most widely used video compression codec on the internet. It compresses raw video into a much smaller file while preserving high visual quality, and it is the codec inside virtually every MP4 file served by TikTok, Instagram, Facebook, X / Twitter, and Reddit.",
    longDefinition:
  ...
  },
  {
    ...
    shortDefinition:
      "AAC (Advanced Audio Coding) is a lossy audio compression codec designed as the successor to MP3. It is the audio format inside almost every MP4 video file served by TikTok, Instagram, Facebook, and Twitter, and at the same bitrate it sounds noticeably better than MP3.",
    longDefinition:
  ...
  },
  {
    ...
    description:
      "A CDN is the network of servers that actually delivers TikTok videos, Instagram photos, and other social media streams to your device. Learn how CDNs work and why they matter for downloading.",
    shortDefinition:
  ...
  },
  {
    ...
    description:
      "Bitrate is the single biggest factor in video quality — more important than resolution. Learn what bitrate means in kbps and Mbps, and why different platforms look different at the same resolution.",
    shortDefinition:
    ...
    longDefinition:
      "Bitrate is often more important than resolution for perceived video quality. A 1080p video at 1 Mbps will look heavily compressed — visible blocking, smeared motion, faded colors — while a 720p video at 5 Mbps will look crisp and clean. This is why TikTok's 1080p videos (typically 2-4 Mbps) often look softer than professionally hosted 1080p videos (typically 5-8 Mbps) even though both are nominally the same resolution.\n\nDifferent platforms cap bitrate at different levels based on their bandwidth budget and audience patience. TikTok and Instagram aggressively compress to keep mobile data usage low; some streaming hosts allow much higher bitrates because users tolerate longer initial buffering. Twitter / X is somewhere in the middle, around 3-6 Mbps for 1080p.\n\nWhen you download a video, you get whatever bitrate the platform stored — there is no way to increase it after the fact, because the original detail is already lost in compression. Tools that claim to 'enhance' or 'upscale' video quality are using AI interpolation (which can add detail that wasn't in the original) and that's a separate process from downloading.",
  ...
  },
  {
    ...
    description:
      "Aspect ratio is the shape of a video — wide (16:9), vertical (9:16), or square (1:1). Learn how each platform uses aspect ratio and why vertical videos look strange on widescreen players.",
    shortDefinition:
      "Aspect ratio is the proportional relationship between a video's width and height. 16:9 (widescreen) is the standard for TVs and most monitors. 9:16 (vertical) is the standard for TikTok, Instagram Reels, and short-form video feeds. 1:1 (square) was popular for early Instagram feed posts.",
    longDefinition:
      "Aspect ratio shapes the entire visual language of a platform. TikTok and Reels use 9:16 because phones are held vertically — the video fills the entire screen with no black bars. Traditional long-form video platforms use 16:9 because TVs and monitors are horizontal, while their short-form feeds shifted to 9:16 to compete with TikTok. Square (1:1) was Instagram's signature for years because it was a compromise between vertical and horizontal that worked on any device orientation.\n\nThe practical issue with mixing aspect ratios: a 9:16 vertical TikTok played on a 16:9 horizontal layout shows huge black bars on the sides. Conversely, a 16:9 video cropped to 9:16 loses content from the sides. There is no perfect cross-platform aspect ratio — creators who want to be everywhere typically shoot 9:16 (because that has the strongest growth tailwind) and accept the bars on horizontal platforms.\n\nWhen you download a video, you get the original aspect ratio the platform stored. DropZap doesn't crop or letterbox; the file you download has the same shape as the source. If you need to change aspect ratio after downloading, you'd need a video editor or FFmpeg's crop/pad filters.",

...
const tabClass = (active: string, hover: string) =>
  `flex items-center justify-center gap-1 px-2 py-1.5 text-[10px] sm:text-xs font-medium cursor-pointer rounded-md bg-foreground/[0.06] border border-foreground/15 text-foreground/80 transition-colors duration-200 hover:text-white ${hover} ${active}`;

export default function HomeTabs() {
  return (
    <Tabs defaultValue="instagram" className="space-y-6">
      <div className="pb-2">
        <TabsList className="glass-strong h-auto p-1.5 gap-1 flex w-full flex-wrap justify-center">
          <TabsTrigger
      ...
      <div className="space-y-6">
        <div>
          <TabsContent value="youtube-thumbnail" className="mt-0">
            <div className="glass rounded-2xl p-6 space-y-4 border-l-4 border-l-orange-500 transition-shadow duration-200 hover:shadow-lg">
          ...
          <TabsContent value="tiktok-thumbnail" className="mt-0">
            <div className="glass rounded-2xl p-6 space-y-4 border-l-4 border-l-pink-500 transition-shadow duration-200 hover:shadow-lg">
          ...
          <TabsContent value="twitter" className="mt-0">
            <div className="glass rounded-2xl p-6 space-y-4 border-l-4 border-l-sky-500 transition-shadow duration-200 hover:shadow-lg">
          ...
          <TabsContent value="tiktok-mp3" className="mt-0">
            <div className="glass rounded-2xl p-6 space-y-4 border-l-4 border-l-emerald-500 transition-shadow duration-200 hover:shadow-lg">
          ...
          <TabsContent value="facebook" className="mt-0">
            <div className="glass rounded-2xl p-6 space-y-4 border-l-4 border-l-blue-600 transition-shadow duration-200 hover:shadow-lg">
          ...
          <TabsContent value="pinterest" className="mt-0">
            <div className="glass rounded-2xl p-6 space-y-4 border-l-4 border-l-red-600 transition-shadow duration-200 hover:shadow-lg">
          ...
          <TabsContent value="mp3" className="mt-0">
            <div className="glass rounded-2xl p-6 space-y-4 border-l-4 border-l-emerald-600 transition-shadow duration-200 hover:shadow-lg">

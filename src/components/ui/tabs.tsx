...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      // NOTE: active-state background/text/shadow are intentionally NOT set here.
      // Each consumer (e.g. homepage tab nav) supplies its own platform-colored
      // data-[state=active]:* classes. Setting defaults here caused the page's
      // data-[state=active]:bg-red-600 (etc.) to lose the cascade in dark mode.
